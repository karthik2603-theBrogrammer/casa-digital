...
const LandingPage = () => {
  ...
  return (
    <motion.section
      className="bg-gradient-to-r from-violet-500 to-fuchsia-500 h-[100vh] w-[100vw] overflow-hidden"
      {...slideAnimation("left")}
    >
      <motion.div {...headContainerAnimation}>
        ...
        >
          <p className="my-1 text-md text-gray-800 md:text-[28px]">
            ...
            use of the iOt technology, namely the ESP8266 and Arduino-Uno as the
            microcontrollers. The Arduino Uno houses(pun intended) the
            ...
            Rendering, a popular cloud feature, its reflected onto your frontend
            web user interface you are seeing currently.
          </p>
